...
criterion_group!(
    ...
    basic::bench_select_order_by,
);

criterion_group!(
    tx,
    transactions::bench_begin_commit,
    transactions::bench_begin_rollback,
    transactions::bench_transaction_insert,
);
...
criterion_main!(basic_ops, tx, agg, join, func, complex, dtype, opt, scale, dml, profile, sanity);
